...
<html>
  ...
  <!-- Facebook and Twitter integration -->
    ...
    <style rel="stylesheet" href="css/thong-tin-ca-nhan.css"></style>
	</head>
	<body>
	...
	<div id="page">
						...
						<div class="col-xs-10 text-right menu-1">
							<ul>
								...
								<li class="has-dropdown active">
									<a href="tours-danhsach.html">Tours</a>
									<ul class="dropdown">
        ...
        <div class="container"> 
            ...
            <div class="col-md-3">          
                ...
                <div class="profile-usertitle-name">                     Họ và Tên:                 </div>                  
                <div class="profile-usertitle-job">                      Cấp bậc:                   </div>              
                </div>                                                
